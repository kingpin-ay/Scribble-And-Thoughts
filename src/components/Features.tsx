...
const Features: FC<appProps> = (props) => {
    return (
        <>
            <Box as="section" className="text-white  body-font tablet:p-[100px] max-[600px]:my-[70px]" fontFamily={"oswald"}>
                <Heading className="container px-5 mx-auto mb-7 ">{props.title}
                    <span className="font-thin text-lg border px-3 mx-2 rounded-full">ALPHA</span>

                </Heading>
                <Text className="container px-5 mx-auto">{props.contentOne}</Text>
                <Text className="container px-5  mx-auto">{props.contentTwo}</Text>
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                    <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">{props.securityTag}</h2>
                                <p className="leading-relaxed">{props.security}</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">{props.rewardTag}</h2>
                                <p className="leading-relaxed">{props.reward}</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">{props.performanceTag}</h2>
                                <p className="leading-relaxed">{props.performance}</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">{props.userTag}</h2>
                                <p className="leading-relaxed">{props.user}</p>
                            </div>
                        </div>
                    </div>
                </div>
