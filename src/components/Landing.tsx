...
function Landing() {
  ...
  return (
    <>
      <div className="tablet:flex px-10 py-5 h-screen text-white bg-gradient-to-t from-black to-theme-black">
        <div className="tablet:flex tablet:flex-1 text-left tablet:items-center my-[110px] ">
            <div className="font-display block">
                <p className="tablet:text-3xl text-blue-green animate-slide-in-right max-[600px]:opacity-100 landing-title-animation-delay text-lg max-[600px]:animate-none">{title}</p>
                ...
                <button className="bg-blue-green px-2 py-2 text-mirage rounded-md landing-button animate-slide-in-right max-[600px]:opacity-100 max-[600px]:animate-none">Read More -&#62;</button>
            </div>
        </div>
          ...
          <ul className="list-none max-[600px]:flex max-[600px]:justify-around max-[600px]:w-full ">
            <li>
              <a href="https://www.youtube.com/channel/UCNTWx8YAn4uhiHuAjhR4rcw"  target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-youtube tablet:opacity-0  animate-slide-in-right max-[600px]:animate-none icons" viewBox="0 0 16 16">
            ...
            <li className="tablet:my-14">
              <a href="https://www.linkedin.com/in/ayush-mondal-a13023205/" target="_blank"  rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-linkedin  tablet:opacity-0 animate-slide-in-right max-[600px]:animate-none icons" viewBox="0 0 16 16">
            ...
            <li className="tablet:my-14">
              <a href="https://github.com/kingpin-ay" target="_blank"  rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-github tablet:opacity-0  animate-slide-in-right max-[600px]:animate-none icons" viewBox="0 0 16 16">
                  <path d={icons.github}/>
                </svg>
              </a>
            </li>
            <li className="tablet:my-14">
              <a href="https://discord.gg/Fycw94eCjM" target="_blank"  rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-discord tablet:opacity-0 animate-slide-in-right max-[600px]:animate-none icons" viewBox="0 0 16 16">
